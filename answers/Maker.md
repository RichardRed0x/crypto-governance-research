...
Maker incorporates input into governance decisions from the community at large via active engagement on the its [chat](https://chat.makerdao.com/), subreddit ([r/MakerDAO](https://www.reddit.com/r/MakerDAO)), GitHub, and other platforms. Weekly governance and risk meetings are live streamed, recordings of which are hosted on [YouTube](https://www.youtube.com/playlist?list=PLLzkWCj8ywWNq5-90-Id6VPSsrk4OWVan) and [Soundcloud](https://soundcloud.com/makerdao/sets/governance-and-risk). Meeting minutes of meetings are hosted on [github](https://github.com/scottrepreneur/maker-minutes). When larger scale changes to the system are considered, on-chain "governance votes" are held to poll community sentiment before implementing them.

A [Governance Dashboard](https://vote.makerdao.com/) displays governance-related information and real-time voting data .


# Blockchain Governance

On-chain voting is enabled using the MKR "governance" token. To vote on proposed changes to the system, MKR holders must lock their MKR in a "voting contract", a smart contract on the Ethereum blockchain which will automatically enact the proposed changes to the Maker system if the vote passes. 1 MKR = 1 vote. Voting contracts can propose a single change or multiple changes at once.
...
The MKR token was launched on Dec 27, 2017. 1,000,000 MKR were premined. Maker did not ICO. In the early days, tokens were sold strategically by the Maker Foundation to members of the community, with preference given to early contributors to the project. Sales were largely negotiated on an individual basis.

In 2017, the Maker foundation made its first institutional sale to Polychain Capital, a deal which was publicly [negotiated](https://www.reddit.com/r/MakerDAO/comments/5mxwxw/polychain_capital_proposal_to_makerdao/) with community input on the MakerDAO subreddit. Subsequent sales to other institutional investors such as Andreesen Horowitz, Placeholder VC, and others) were modeled on this deal.

Because MKR must be used to pay stability fees, and this MKR is burned upon payment, the supply of MKR is continually decreasing as CDPs are paid off. On Jan 29th, 2019, Rune Christensen estimated on the Unchained podcast that "less than 0.1% of the total supply" had been burned.
...
Maker smart contracts run on the Ethereum blockchain. Presumably it doesn't matter what full node a user is running when interacting with Maker.
...
In addition to the smart contracts underpinning the "DAI stablecoin system", the Maker foundation has also funded the creation of other related software, including the Governance Dashboard, hackathon projects, reference software for external actors (keepers, market making bots, etc.), and the Oasis DEX, the first fully on-chain DEX running on Ethereum. In January 2019, Oasis DEX was taken down, with plans to replace it with a DEX capable of supporting multi-collateral DAI.
